package org.nimo.aquarium.member.controller;
...
import org.nimo.aquarium.member.domain.dto.JoinRequest;
import org.nimo.aquarium.member.domain.dto.LoginRequest;
import org.nimo.aquarium.member.domain.entity.User;
import org.nimo.aquarium.member.service.UserService;
...
public class LoginController {
    ...
    public String home(@CookieValue(name = "userId", required = false) Long userId, Model model){
        model.addAttribute("loginType", "cooke-login");
